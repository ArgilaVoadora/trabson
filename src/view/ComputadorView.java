...
public class ComputadorView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ListaPortas = new javax.swing.JList<>();
        ...
        ListaPortas.setFocusable(false);
        jScrollPane1.setViewportView(ListaPortas);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < comp.getPortaUsb().size(); i++) {
                    lista.add(comp.getPortaUsb().get(i).getNome());
                }
                ...
                ListaPortas.setModel(listModel);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JList<String> ListaPortas;
